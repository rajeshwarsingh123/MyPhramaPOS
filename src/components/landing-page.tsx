    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center gap-2.5">
            <div className="w-9 h-9 rounded-lg bg-primary/20 flex items-center justify-center ring-1 ring-primary/20">
              <Cross className="w-5 w-5 text-primary" />
            </div>
            <div>
              <span className="text-base font-bold text-landing-foreground">PharmPOS</span>
              <span className="hidden sm:inline text-[10px] text-landing-muted ml-2">Pharmacy Management</span>
            </div>
          </div>
          ...
          <div className="hidden md:flex items-center gap-8 text-sm text-landing-muted">
            {['Features', 'Demo', 'Pricing'].map((item) => (
              <a
                ...
                className="hover:text-landing-foreground transition-colors font-medium"
              >
                {item}
              </a>
            ))}
